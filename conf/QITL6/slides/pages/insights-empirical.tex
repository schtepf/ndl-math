...
\begin{frame}[c]
  \frametitle{Non-equivocal positive assoc.: convergence}
...
\begin{frame}[c]
  \frametitle{Non-equivocal positive assoc.: convergence with 1x data}
...
\begin{frame}[c]
  \frametitle{Non-equivocal negative assoc.: convergence with 1x data}
...
\begin{frame}[c]
  \frametitle{Near-perfect positive assoc.: non-convergence with 1x data}
...
\begin{frame}[c]
  \frametitle{Near-perfect neg.\ assoc.: non-convergence with 1x data}
